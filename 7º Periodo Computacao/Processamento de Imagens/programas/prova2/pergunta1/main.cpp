...
int main(int argc, const char** argv)
{
    ...
    nestedCascade.load("/opt/opencv/data/haarcascades/haarcascade_eye.xml");
    ...
    //detecção direto de uma imagem
    Mat imagem = imread("presos.jpg", IMREAD_COLOR);
    detectAndDraw(imagem, cascade, nestedCascade, scale);
    waitKey(0);
