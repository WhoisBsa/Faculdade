...
public class ViewMenu extends javax.swing.JFrame {
    ...
    public ViewMenu(Banco banco) {
        this.banco = banco;
        for (int i = 0; i < 4; i++) {
            contaCorrente.add(banco.procurarConta(i+1, contaCorrente.get(i)));
        }
        initComponents();
        setLocationRelativeTo(null);
    }
    ...
    private void btnSacarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSacarActionPerformed
        ...
        try {
            if(input.isBlank())
                ...
                String result = this.contaCorrente.get(0).sacar(Double.parseDouble(input));
                JOptionPane.showMessageDialog(rootPane, result);
                lblSaldo.setText("<html>Saldo: " + contaCorrente.get(0).getSaldo());
            }
    ...
    private void btnDepositarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDepositarActionPerformed
        ...
        try {
            if(input.isBlank())
                ...
                String result = this.contaCorrente.get(0).depositar(Double.parseDouble(input));
        ...
        if(selected != null){ 
            ...
            if(selectedString.equals("Conta Corrente")){
                ...
                for(int i = 1; i < posCorrente; i++) {
                    if(contaCorrente.get(i).getNumConta() != 0)
                        contas += "Conta " + (i+1) + ": " + contaCorrente.get(i).getNumConta() + "\n";
                }
            } else {
                contas += "\nContas Poupanca:\n";
                for(int i = 0; i < posPoupanca; i ++) {
                    if(contaPoupanca.get(i).getNumConta() != 0)
                        contas += "Conta " + (i+1) + ": " + contaPoupanca.get(i).getNumConta() + "\n";
                }
            }
                ...
                if(input.isBlank() || conta.isBlank())
                    ...
                    if(selectedString.equals("Conta Corrente")){
                        for(int i = 0; i < posCorrente; i++) {
                            if(contaCorrente.get(i).getNumConta() == Integer.parseInt(conta) && i != 0 && contaCorrente.get(i).getNumConta() != 0) {
                                result = this.contaCorrente.get(0).transferir(Double.parseDouble(input), contaCorrente.get(i));
                                lblSaldo.setText("<html>Saldo: " + contaCorrente.get(0).getSaldo());
                                break;
                            }
                        ...
                        for(int i = 0; i < posPoupanca; i++) {
                            if(contaPoupanca.get(i).getNumConta() == Integer.parseInt(conta) && contaPoupanca.get(i).getNumConta() != 0){
                                result = this.contaCorrente.get(0).transferir(Double.parseDouble(input), contaPoupanca.get(i));
                                lblSaldo.setText("<html>Saldo: " + contaCorrente.get(0).getSaldo());
                            }
                        }
                    }
            ...
            try {
                if(selectedString.equals("Conta Corrente")){
                    ...
                    if(String.valueOf(saldo).isBlank())
                        ...
                        contaCorrente.add(new ContaCorrente(numConta, saldo));
                        banco.inserir(contaCorrente.get(posCorrente));
                        posCorrente++;
                        numConta++;
                    }
                    ...
                    if(String.valueOf(saldo).isBlank())
                        ...
                        contaPoupanca.add(new ContaPoupanca(numConta, saldo));
                        banco.inserir(contaPoupanca.get(posPoupanca));
                        posPoupanca++;
                        numConta++;
                    }
                }
    ...
    private void lblDadosAncestorAdded(javax.swing.event.AncestorEvent evt) {//GEN-FIRST:event_lblDadosAncestorAdded
        lblDados.setText("<html>Numero da conta: " + contaCorrente.get(0).getNumConta());
        lblSaldo.setText("<html>Saldo: " + contaCorrente.get(0).getSaldo());
    ...
    private void btnSelecionarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSelecionarActionPerformed
        ...
        try {
            if(input.isBlank())
                ...
                for(int i = 0; i < posCorrente; i++) {
                    if(contaCorrente.get(i).getNumConta() == Integer.parseInt(input)) {
                        contaC = i;
                        result = JOptionPane.showOptionDialog(rootPane,  contaCorrente.get(i).mostrarDados(), 
                ...
                for(int i = 0; i < posPoupanca; i++) {
                    if(contaPoupanca.get(i).getNumConta() == Integer.parseInt(input)) {
                        contaP = i;
                        result = JOptionPane.showOptionDialog(rootPane,  contaPoupanca.get(i).mostrarDados(), 
                                "Escolha uma Opção", JOptionPane.YES_NO_CANCEL_OPTION, JOptionPane.PLAIN_MESSAGE,
                                null, options1, null);
                        contaOk = true;
                    }
